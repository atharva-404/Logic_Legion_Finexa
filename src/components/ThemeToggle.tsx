...
export default function ThemeToggle({ size = 'md' }: { size?: 'sm' | 'md' }) {
    ...
    const knobX = isDark ? pad : trackW - knobSize - pad;
        ...
        <motion.button
            ...
            style={{
                ...
                ...(isDark ? {
                    ...
                    /* Light mode: very light purple track, subtle purple border */
                    background: '#fbf7ff',
                    boxShadow: '0 0 0 1.5px rgba(124, 85, 237, 0.45), 0 2px 8px rgba(124, 58, 237, 0.12)',
                }),
            }}
        >
            {/* Decorative dots (dark: star dots / light: tick marks) */}
            <AnimatePresence>
                {isDark && (
                    <motion.span
                        key="stars"
