        ...
        <div className="space-y-10 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    { label: 'Compliance Rate', value: `${completedCount}/${habits.length}`, icon: Trophy, color: isDark ? '#a855f7' : '#7c3aed' },
                            ...
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <div className="flex flex-col items-end gap-1">
                                    <div className="flex items-center gap-1 text-orange-400 text-[10px] font-bold uppercase tracking-tighter">
                                        <Flame size={12} /> {habit.streak} CYCLES
                                    </div>
                                    <span className={`text-[10px] font-bold tracking-widest ${isDark ? 'text-yellow-400' : 'text-yellow-600'}`}>+5 Rating</span>
                                </div>
                            </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
                    {(badges || []).map((badge, idx) => {
                        ...
                        const threshold = thresholds[idx] || 100;
