...
export default function SignIn() {
    ...
    const demoBtn = isDark
        ? { color: 'rgba(168,85,247,0.45)', border: '1px solid rgba(168,85,247,0.1)' }
        : { color: 'rgba(0,0,0,0.4)', border: '1px solid rgba(0,0,0,0.1)' };
    const demoBtnHover = isDark
        ? { color: '#a855f7', borderColor: 'rgba(168,85,247,0.28)', background: 'rgba(168,85,247,0.05)' }
        : { color: '#0a0a0a', borderColor: 'rgba(0,0,0,0.25)', background: 'rgba(0,0,0,0.03)' };
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3.5">
                            ...
                            <motion.div variants={item}>
                                ...
                                <button type="button"
                                    ...
                                    style={demoBtn}
                                    onMouseEnter={e => { Object.assign(e.currentTarget.style, demoBtnHover); }}
                                    onMouseLeave={e => { Object.assign(e.currentTarget.style, demoBtn); }}>
                                    Use demo account
                                </button>
                            </motion.div>
                        </form>
